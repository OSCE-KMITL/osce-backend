...
export class ProgressReport {
    ...
    constructor(report_no: number, commute_score: number, advisement_score: number, work_score: number, current_res: string, mentor_name: string, mentor_lastname: string, mentor_position: string, other_suggest: string) {
